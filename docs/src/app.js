window.onload = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (var i = 0; i < divs.length; i++) {
                ...
                divs[i].onclick = function() {
                    ...
                    if(document.body.contains(document.getElementById('DOCJS_LINK_' + NEXT_PAGE))){
    ...
    function DOCJS_OPENPAGE(value) {
        document.getElementById('DOCJS_PAGE_CONTENT').innerHTML = '<div style="text-align:center;padding: 25vh 0;"><svg class="spinner" viewBox="0 0 50 50"> <circle class="spinner__path" cx="25" cy="25" r="20" fill="none" stroke-width="4"></circle> </svg><br><h5>Loading...</h5></div>';
